...
import { Printer, ArrowLeft, CheckCircle2, Building2, QrCode } from "lucide-react";
...
function LogoPlaceholder({ logoUrl, schoolName }: { logoUrl?: string | null; schoolName?: string }) {
  return (
    <div className="flex flex-col items-center justify-center w-20 h-20 border border-[#E5E0D8] rounded-2xl bg-[#F5F3EC] shrink-0 shadow-xs overflow-hidden p-2 relative group">
      {logoUrl ? (
        <img
          src={logoUrl}
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 print:hidden">
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="inline-flex items-center gap-2 h-11 px-5 rounded-xl border border-[#E5E0D8] bg-[#F5F3EC] text-xs font-bold text-[#1A1A1A] hover:bg-[#EAE6DC] transition-all shadow-sm active:scale-[0.98]"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-2 h-11 px-6 rounded-xl bg-[#0C3B2E] text-white text-xs font-extrabold hover:bg-[#10523E] transition-all shadow-sm active:scale-[0.98]"
          >
